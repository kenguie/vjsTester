...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define('videojs',[],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.videojs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
  ...
  var MuteToggle = function (_Button) {
    ...
    MuteToggle.prototype.update = function update(event) {
      ...
      if (this.player_.paused()) {
        Dom.addElClass(this.el_, 'vjs-tempvol-' + vol);
      }
  ...
  */
  ...
  var requirevjsstring = 'requirevideojsbaselibrary';
  if (requirevjsstring === 'requirevideojsbaselibrary'){
      console.log('Video.js is initalizing');
  }
  ...
  var TextTrackDisplay = function (_Component) {
    ...
    TextTrackDisplay.prototype.updateForTrack = function updateForTrack(track) {
      ...
      while (i--) {
        ...
        var cueDivTopParent = cueDiv.parentElement.parentElement;
        ...
        if (overrides.edgeStyle) {
          ...
          if (overrides.fontPercent == undefined) {
          ...
          if (overrides.fontPercent) {
              ...
              cueDiv.style.fontSize = overrides.fontPercent + 'em';
              //cueDiv.style.height = 'auto';
              //cueDiv.style.top = 'auto';
              //cueDiv.style.bottom = '10px';
          }
          ...
          var cueDivTopParentChildren = cueDivTopParent.children[0].children;
  
          if (cueDivTopParentChildren.length > 1){
            for (var k = 0; k < cueDivTopParentChildren.length; k++){
              var childBottom = 10;
              for (var j = k + 1; j < cueDivTopParentChildren.length; j++){
                childBottom += cueDivTopParentChildren[j].scrollHeight;
              }
              cueDivTopParentChildren[k].style.bottom = childBottom + 'px';
            }
          }
    ...
    (0, _xhr2['default'])(opts, Fn.bind(this, function (err, response, responseBody) {
      ...
      if (typeof _window2['default'].WebVTT !== 'function') {
        ...
        if (response.statusCode == 404) {
          //track.addCue(new VTTCue(0.00,9999.99,'Captions Unavailable'));
        } else {
  ...
  var TextTrack = function (_Track) {
    ...
    function TextTrack() {
      ...
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      this.playerVideoType = videojs(options.tech.options_.playerId).parent.videotype;
      ...
      Object.defineProperty(tt, 'activeCues', {
        get: function get() {
          ...
          for (var i = 0, l = this.cues.length; i < l; i++) {
            ...
            //HERE IF LIVESTREAM USE ORIGINAL WAY FOR CUE END TIME
            
            if (this.playerVideoType == 'livestream') {
              ...
              if (cue.startTime <= ct && cue.endTime + 1.5 >= ct) {
                active.push(cue);
              } else if (cue.startTime === cue.endTime && cue.startTime <= ct && cue.startTime + 0.5 >= ct) {
                active.push(cue);
              }
